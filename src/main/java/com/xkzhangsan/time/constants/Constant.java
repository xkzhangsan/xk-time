...
public class Constant {
	 ...
	 * 每分钟毫秒数 60*1000
	 */
	public static final int MILLISECOND_PER_MINUTE = SECONDS_PER_MINUTE * MILLISECOND_PER_SECONDS;
	
	/**
	 * 每小时毫秒数 60*60*1000
	 */
	public static final int MILLISECOND_PER_HOUR = MINUTES_PER_HOUR * MILLISECOND_PER_MINUTE;
	
	/**
	 * 每天毫秒数 24*60*60*1000
	 */
	public static final int MILLISECOND_PER_DAY = HOURS_PER_DAY * MILLISECOND_PER_HOUR;
	
	/**
	 * 每星期毫秒数 7*24*60*60*1000
	 */
	public static final int MILLISECOND_PER_WEEK = DAY_PER_WEEK * MILLISECOND_PER_DAY;
