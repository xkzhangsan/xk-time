...
public class TimeNLPUtilTest {
	...
	public void timeNLPTest(){
        ...
        System.out.println(DateTimeFormatterUtil.formatToDateTimeStr(timeNLPList.get(0).getTime()) + "-" + timeNLPList.get(0).getIsAllDayTime());
        System.out.println(DateTimeFormatterUtil.formatToDateTimeStr(timeNLPList.get(1).getTime()) + "-" + timeNLPList.get(1).getIsAllDayTime());
		...
		timeNLPList = TimeNLPUtil.parse("《辽宁日报》今日报道，7月18日辽宁召开省委常委扩大会，会议从下午两点半开到六点半，主要议题为：落实中央巡视整改要求。", "2016-07-19-00-00-00");
